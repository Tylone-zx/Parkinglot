...
public class RedisUtil {
    ...
    public void saveParklotPosition(Parklot parklot) {
        redisTemplate.opsForGeo().add("Parklot", new Point(parklot.getLongitude().doubleValue(), parklot.getLatitude().doubleValue()), parklot.getParkName());
    }

    public void removeParklotPosition(String parklotName) {
        redisTemplate.opsForGeo().remove("Parklot", parklotName);
    }
